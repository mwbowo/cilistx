   ...
   stage('Build database') {
     steps {
       dir('database') {
         ...
         sh 'docker tag cilist-pipeline-db:$GIT_COMMIT_SHORT mwbowo/cilist-pipeline-db:$GIT_COMMIT_SHORT'
         sh 'docker push mwbowo/cilist-pipeline-db:$GIT_COMMIT_SHORT'
       }
     }
   }
   ...
   stage('Build backend') {
     steps {
       dir('backend') {
         ...
         sh 'docker tag cilist-pipeline-be:$GIT_COMMIT_SHORT mwbowo/cilist-pipeline-be:$GIT_COMMIT_SHORT'
         sh 'docker push mwbowo/cilist-pipeline-be:$GIT_COMMIT_SHORT'
       }
     }
   }
   ...
   stage('Build frontend') {
     steps {
       dir('frontend') {
         ...
         sh 'docker tag cilist-pipeline-fe:$GIT_COMMIT_SHORT mwbowo/cilist-pipeline-fe:$GIT_COMMIT_SHORT'
         sh 'docker push mwbowo/cilist-pipeline-fe:$GIT_COMMIT_SHORT'
       }
     }
   }
